        ...
        <div className="mt-3 pt-3 border-t border-gray-300 space-y-1">
          ...
          {Array.isArray(bookingData.selected_services) && bookingData.selected_services.length > 0 && (
            <>
              ...
              {(bookingData.selected_services as { service_id: number; name: string; price: number; price_mode: string; calculated_price: number; person_count?: number; unit_count?: number }[]).map((svc) => (
